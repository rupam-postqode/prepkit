...
export default function LearningPathPage() {
  ...
  // Refetch data when window gains focus (user returns from path changes)
  useEffect(() => {
    const handleVisibilityChange = () => {
      if (document.visibilityState === 'visible' && params.pathId) {
        fetchPathData();
      }
    };
  ...
  // Breadcrumbs are now automatically generated by the centralized system
